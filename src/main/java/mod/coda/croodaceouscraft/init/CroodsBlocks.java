...
public class CroodsBlocks {
    ...
    public static final RegistryObject<Block> CROODACEOUS_STONE = REGISTER.register("croodaceous_stone", () -> new Block(Block.Properties.create(Material.ROCK, MaterialColor.BROWN).hardnessAndResistance(1.5f, 6.0f)));
